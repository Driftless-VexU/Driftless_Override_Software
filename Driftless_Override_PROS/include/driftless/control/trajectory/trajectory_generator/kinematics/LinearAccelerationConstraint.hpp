#ifndef __LINEAR_ACCELERATION_CONSTRAINT_HPP__
#define __LINEAR_ACCELERATION_CONSTRAINT_HPP__
...
/// @brief Kinematic constraint to limit the linear acceleration of the robot
/// @author Matthew Backman
class LinearAccelerationConstraint : public IKinematicConstraint {
 private:
  /// @brief The max linear acceleration of the robot in inches per second^2
 ...
 public:
  ...
  /// @brief Sets the max linear acceleration of the robot
