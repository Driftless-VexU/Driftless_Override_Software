...
class PIDHolonomicTurn : public ITurn {
 ...
 private:
  ...
  bool m_forced_direction_reached{};
  ...
  /// @return __double__ The velocity for the drive train
  double calculateDriveVelocity(double current_angle, double target_angle);
